...
function Navigation() {
  ...
  return (
    <section className="NavbarComponent">
      ...
      <Navbar className='responsive-navbar' collapseOnSelect expand="lg" variant="dark">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav className='nav-items'>
            ...
            {document.cookie ? <p></p> : <Nav.Link className='nav-item sign-up' href="/register">Sign Up</Nav.Link>}
          </Nav>
        </Navbar.Collapse>
      </Navbar>
    </section>
